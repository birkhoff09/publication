...
@Service
@Transactional
public class AuthorServiceImpl extends ServiceImpl<Author> implements IAuthorService {

    @Autowired
    public AuthorServiceImpl(AuthorRepository repository, IGenericRepository genericRepository) {
